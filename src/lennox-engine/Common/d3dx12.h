...
//
//  Plik:       d3dx12.h
//  Zawartoœæ:    biblioteka narzêdzia D3DX12
//
//////////////////////////////////////////////////////////////////////////////
...
struct CD3DX12_CLEAR_VALUE : public D3D12_CLEAR_VALUE
{
    ...
    {
        Format = format;
        /* U¿yj funkcji memcpy, aby zachowaæ wartoœci NAN */
...
//------------------------------------------------------------------------------------------------
// Funkcja memcpy dzia³aj¹ca wiersz po wierszu
...
//------------------------------------------------------------------------------------------------
// Zwraca wymagany rozmiar buforu do u¿ycia na potrzeby przekazywania danych
...
//------------------------------------------------------------------------------------------------
// Wszystkie tablice musz¹ byæ wype³nione (np. przez wywo³anie metody GetCopyableFootprints)
...
//------------------------------------------------------------------------------------------------
// Implementacja elementu UpdateSubresources z alokacj¹ na stercie
inline UINT64 UpdateSubresources( 
    _In_ ID3D12GraphicsCommandList* pCmdList,
    _In_ ID3D12Resource* pDestinationResource,
    _In_ ID3D12Resource* pIntermediate,
...
//------------------------------------------------------------------------------------------------
// Implementacja elementu UpdateSubresources z alokacj¹ na stosie
...
{
    // To rzutowanie jest przydatne podczas przekazywania silnie typizowanych wskaŸników listy poleceñ do
    // ExecuteCommandLists.
    // To rzutowanie jest prawid³owe, gdy jest uwzglêdniana sta³oœæ. Interfejsy API D3D12
    // uwzglêdnij sta³oœæ ich argumentów.
