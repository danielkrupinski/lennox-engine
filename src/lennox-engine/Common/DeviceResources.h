...
namespace DX
{
	static const UINT c_frameCount = 3;		// Użyj potrójnego buforowania.
	...
	private:
		...
		// Synchronizacja procesora CPU/GPU.
		Microsoft::WRL::ComPtr<ID3D12Fence>				m_fence;
		UINT64											m_fenceValues[c_frameCount];
		HANDLE											m_fenceEvent;

		// Odwołanie do okna przechowywane w pamięci podręcznej.
		...
		// Jest to wartość DPI, która będzie zgłaszana z powrotem do aplikacji. Uwzględnia ona, czy aplikacja obsługuje ekrany o wysokiej rozdzielczości.
